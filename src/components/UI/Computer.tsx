...
export default function Computer({ onClose, onCompleteSale }: ComputerProps) {
  ...
  const [activeTab, setActiveTab] = useState<
    "insurance" | "payment" | "appointments"
  >("insurance");
      ...
      >
        ...
        <div className="w-64 bg-black border-r-4 border-white flex flex-col">
          <div className="p-6 border-b-4 border-white">
            <h2 className="text-sm font-black italic text-white animate-pulse">
              PAL-OS v1.0
            </h2>
          </div>
            ...
            {[
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-4 border-4 transition-all text-[8px] font-black ${
                  activeTab === tab.id
                    ? "bg-white text-black border-white shadow-[4px_4px_0_0_rgba(255,255,255,0.3)]"
        ...
        <div className="flex-1 bg-black relative overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === "payment" && (
              ...
              >
                <div className="mb-6 text-center">
                  <h1 className="text-xl font-black text-white underline decoration-4 decoration-green-500 underline-offset-8">
                    CREDIT_TERMINAL_v4
                  </h1>
                  <p className="text-[6px] text-green-500/50 mt-4 font-mono">
                    CONNECTION: ENCRYPTED_SSL_AES256
                  </p>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-8">
                  {!showSuccess ? (
                    <div className="flex gap-12 items-center">
                      ...
                      <div className="w-64 bg-[#1a1a1a] border-x-12 border-t-12 border-b-24 border-[#2a2a2a] p-4 shadow-[20px_20px_0_0_rgba(0,0,0,1)] relative flex flex-col rounded-t-xl">
                        ...
                        <div className="w-full h-32 bg-[#0a1f0a] border-4 border-black mb-6 p-3 flex flex-col items-center justify-center relative overflow-hidden">
                          ...
                          {paymentStep === "IDLE" && (
                            <div className="text-center">
                              <div className="text-[6px] text-green-500/40 mb-1 uppercase">
                                TOTAL
                              </div>
                          ...
                          {paymentStep === "INSERT_CARD" && (
                            <div className="text-center space-y-2 animate-pulse">
                              ...
                              <div className="text-[8px] font-black text-green-400">
                                INSERT CARD
                              </div>
                            </div>
                          )}
                            ...
                            <div className="text-center space-y-4">
                              ...
                              <div className="flex gap-2 justify-center">
                                {[...Array(4)].map((_, i) => (
                                  <div
                                    key={i}
                                    className={`w-3 h-3 border-2 border-green-500/30 flex items-center justify-center ${pin.length > i ? "bg-green-500" : ""}`}
                                  />
                                ))}
                              </div>
                            </div>
                          ...
                          {paymentStep === "PROCESSING" && (
                            <div className="text-center space-y-2">
                              <div className="text-[8px] font-black text-green-400 animate-pulse">
                                AUTHORIZING...
                              </div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <button className="h-6 bg-red-900/40 text-red-500 text-[6px] font-black border-b-2 border-red-950 rounded-sm">
                            CANCEL
                          </button>
                          <button className="h-6 bg-green-900/40 text-green-500 text-[6px] font-black border-b-2 border-green-950 rounded-sm">
                            ENTER
                          </button>
                        </div>
                        ...
                        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-48 h-6 bg-[#0a0a0a] border-t-2 border-white/10 flex items-center justify-center">
                          ...
                          {paymentStep === "INSERT_CARD" && (
                            ...
                            >
                              ...
                              <div className="text-[4px] text-white/50">
                                PLATINUM_CARD
                              </div>
                              <div className="mt-auto text-[6px] text-white font-mono">
                                **** **** **** 4242
                              </div>
                            </motion.div>
                          )}
                      ...
                      <div className="w-64 space-y-4">
                        ...
                        {paymentStep === "INSERT_CARD" && (
                          <div className="bg-blue-900/20 border-2 border-blue-500/50 p-4 rounded-lg">
                            <p className="text-[8px] text-blue-400 font-black animate-pulse">
                              ACTION: CLICK THE CARD BELOW TO INSERT
                            </p>
                          </div>
                        )}
                        ...
                        {paymentStep === "PIN_ENTRY" && (
                          <div className="bg-yellow-900/20 border-2 border-yellow-500/50 p-4 rounded-lg">
                            <p className="text-[8px] text-yellow-400 font-black">
                              ACTION: USE KEYPAD TO ENTER PIN (any 4 digits)
                            </p>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="text-center space-y-8">
                      ...
                      <div className="text-green-500 font-black animate-pulse uppercase tracking-[4px] text-[8px]">
                        Printing Receipt...
                      </div>
                      ...
                      >
                        <div className="text-[6px] font-black text-black border-b border-black/10 pb-2">
                          OPTICAL_CLINIC_v1
                        </div>
            ...
            {activeTab === "appointments" && (
              ...
              >
                <h1 className="text-xl font-black text-white underline decoration-4 decoration-yellow-500 underline-offset-8 mb-12 uppercase">
                  Operation_Logs
                </h1>
                <div className="space-y-4 flex-1">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center justify-between p-6 bg-black border-4 border-white/20 hover:border-white transition-all cursor-pointer group hover:bg-slate-950"
                    >
                      <div className="flex items-center gap-8">
                        ...
                        <div className="space-y-1">
                          <div className="font-black text-sm text-white group-hover:text-blue-400">
                            {apt.name}
                          </div>
                          <div className="text-[6px] text-white/40 uppercase group-hover:text-white/60">
                            {apt.type}
                          </div>
                        </div>
                      </div>
