    ...
    >
      ...
      >
        ...
        <div className="text-center mb-10 relative">
          <h2 className="text-2xl font-black mb-2 text-white italic underline decoration-blue-500 decoration-4">
            PAL-9000 ANALYZER
          </h2>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="hidden xl:block w-48 h-64 relative border-4 border-white overflow-hidden bg-white/5">
            ...
            <div className="absolute top-2 left-2 text-[6px] font-black text-white/40 uppercase">
              Ref: Model_9000
            </div>
          </div>
            ...
            <div className="relative w-24 h-48 bg-black border-4 border-white overflow-hidden shadow-inner flex flex-col items-center justify-center group">
              ...
              >
                {[
                  ...
                  <div
                    key={val}
                    className={`text-sm font-black ${Math.abs(power - val) < 0.1 ? "text-blue-400 scale-125" : "text-slate-700"}`}
                  >
                    {val > 0 ? "+" : ""}
                    {val.toFixed(2)}
                  </div>
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="text-center">
              <div className="text-[8px] font-black text-slate-500 uppercase mb-2 tracking-tighter">
                Alignment
              </div>
              <div
                className={`text-4xl font-black ${isAligned ? "text-green-400" : "text-blue-500"}`}
              >
              ...
              >
                ...
                >
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
                      className="absolute w-4 h-12 bg-white"
                      style={{
            ...
            <p className="text-[6px] text-slate-500 uppercase font-black">
              Drag Wheel
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 flex justify-between items-end border-t-4 border-white pt-8">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <div
                className={`w-4 h-4 ${isAligned ? "bg-green-500" : "bg-red-500"}`}
              />
          ...
          <div className="text-right text-[6px] text-slate-700 leading-relaxed uppercase">
            Device: PAL-9000
            <br />
            Output: {Math.round(rotation)}, {power.toFixed(2)}
            <br />
            System: OK
          </div>
        </div>
