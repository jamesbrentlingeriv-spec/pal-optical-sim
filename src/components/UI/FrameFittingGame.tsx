...
export const FrameFittingGame: React.FC<FrameFittingGameProps> = ({
  ...
  const diffs = useMemo(
    () => ({
      ...
      bridge: Math.abs(
        measurements.bridgeWidth - targetMeasurements.bridgeWidth,
      ),
      temple: Math.abs(
        measurements.templeLength - targetMeasurements.templeLength,
      ),
    }),
        ...
        <div className="flex flex-col md:flex-row gap-8 relative z-10">
          ...
          <div className="w-full md:w-80 flex flex-col gap-6">
            <div className="border-b-4 border-white pb-4">
              ...
              <p className="text-blue-400 font-black text-xs uppercase tracking-widest mt-1">
                Patient: {patientName}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span
                    className={`text-xl font-black ${diffs.frame < 5 ? "text-green-400" : "text-white"}`}
                  >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span
                    className={`text-xl font-black ${diffs.bridge < 5 ? "text-green-400" : "text-white"}`}
                  >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span
                    className={`text-xl font-black ${diffs.temple < 5 ? "text-green-400" : "text-white"}`}
                  >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setMeasurements((m) => ({
                      ...m,
                      templeLength: parseInt(e.target.value),
                    }))
                  }
                  className="w-full h-4 bg-slate-800 appearance-none cursor-pointer border-2 border-white accent-blue-500"
                />
          ...
          {showSuccess && (
            ...
            >
              <div className="flex flex-col items-center gap-6">
                ...
                <h3 className="text-6xl font-black italic text-white uppercase tracking-tighter">
                  Perfect Fit!
                </h3>
                <p className="text-white font-bold opacity-80 uppercase tracking-widest">
                  The patient loves their new look.
                </p>
              </div>
            </motion.div>
          )}
